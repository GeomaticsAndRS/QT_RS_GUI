#ifndef GEOMETRYCORRECTION_H
#define GEOMETRYCORRECTION_H

#include "ui_geometrycorrection.h"
...
class GeometryCorrection : public QMainWindow
{
	Q_OBJECT

public:
	GeometryCorrection(QWidget *parent = 0, Qt::WFlags flags = 0);
	~GeometryCorrection();

private:
	Ui::GeometryCorrectionClass ui;
...
public:
	...
	ShowImageBase1 *pShowimagebaseUI;
